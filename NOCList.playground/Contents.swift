...
let a01 = (coverName: "Ethan Hunt", realName: "Tom Cruise", accessLevel: 8, compromised: false)
let a02 = (coverName: "Jim Phelps", realName: "Jon Voight", accessLevel: 9, compromised: true)
let a03 = (coverName: "Claire Phelps", realName: "Emmanuelle Beart", accessLevel: 5, compromised: false)
let a04 = (coverName: "Eugene Kittridge", realName: "Henry Czerny", accessLevel: 10, compromised: true)
let a05 = (coverName: "Franz Krieger", realName: "Jean Reno", accessLevel: 4, compromised: false)
let a06 = (coverName: "Luther Stickell", realName: "Ving Rhames", accessLevel: 4, compromised: false)
let a07 = (coverName: "Sarah Davies", realName: "Kristin Scott Thomas", accessLevel: 5, compromised: true)
let a08 = (coverName: "Max RotGrab", realName: "Vanessa Redgrave", accessLevel: 4, compromised: false)
let a09 = (coverName: "Hannah Williams", realName: "Ingeborga Dapkūnaitė", accessLevel: 5, compromised: true)
...
func numOfCompromisedAgents(agentsTuple: [Agent]) -> Int {
    var count = 0
...
let answer = numOfCompromisedAgents(agentsTuple: theList)

print("\(answer) agents have been compromised!")
//: ## Step 5
...
func findCleanAgents(agentsTuple: [Agent]) -> [Agent] {
    var agents = [(String, String, Int, Bool)]()
...
let cleanAgents = findCleanAgents(agentsTuple: theList)

print("\(cleanAgents.count) clean agents out of \(theList.count) total agents.")
//: ## Step 7
...
findHighRisk(agentsTuple: theList)
//: ## Step 9
...
func agentAccessLevelBreakdown(agentsTuple: [Agent]) {
    var lowLevel = 0
    var midLevel = 0
    var highLevel = 0
    ...
    for agent in agentsTuple {
        ...
        case 8...Int.max:
            highLevel += 1
        default:
            print("Access Level: \(agent.accessLevel) is not categorized. Type: \(type(of: agent.accessLevel))")
        }
    }
...
agentAccessLevelBreakdown(agentsTuple: theList)
//: ## Step 11 (Optional)
...
func printAgents(agentsTuple: [Agent]) {
    var newList = agentsTuple
    newList.sort{$0.2 < $1.2}
...
printAgents(agentsTuple: theList)
